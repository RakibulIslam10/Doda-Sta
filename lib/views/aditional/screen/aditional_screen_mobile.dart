          ...
          child: ListView(
            ...
            children: [
              ...
              Obx(
                  ...
                  children:
                  List.generate(controller.dayList.length, (index) {
    ...
    await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => MapLocationPicker(
          ...
          geoCodingConfig:
          GeoCodingConfig(apiKey: "AIzaSyC_qKHmzl-HHB9hr8-fWGmhETSVR2H0894"),
          searchConfig:
          SearchConfig(apiKey: "AIzaSyC_qKHmzl-HHB9hr8-fWGmhETSVR2H0894"),
        ),
      ),
    );
  }
