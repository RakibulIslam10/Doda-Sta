...
class SearchBarWidgetView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return  Container(
      margin: EdgeInsets.symmetric(vertical: Dimensions.verticalSize * 0.8),
      decoration: BoxDecoration(border: Border.all(color: CustomColors.primary,width: 1.4),
      ...
      child: Row(children: [
        Padding(
          ...
          child: Icon(CupertinoIcons.search,color: CustomColors.primary,size: Dimensions.iconSizeLarge,),
        ),
